...
class LaserScanVis:
  ...
  def __init__(self,
    ...
    additional_sequences_log_path = None,
  ):
    self.scan = scan
    ...
    self.additional_sequences_log_path = additional_sequences_log_path
  ...
  def update_scan(self):
    ...
    if self.semantics:
      ...
      if self.additional_sequences_log_path:
        path = os.path.join(self.additional_sequences_log_path, f"{self.offset:06}.ply")
        self.save_points(points, path, format = "ply")
