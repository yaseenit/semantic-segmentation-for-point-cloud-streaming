...
if __name__ == '__main__':
  ...
  parser.add_argument(
    '--additional_sequences_log_path',
    type=str,
    required=False,
    help='Path where to save the results of the additional sequence visualization, including stride compensation'
  )
  parser.add_argument(
    '--background_color',
    type=str,
  ...
  vis = LaserScanVis(scan=scan,
                     ...
                     additional_sequences_log_path = FLAGS.additional_sequences_log_path,
  )
